...
/** Stable, bounded error information returned by the Ability persistence boundary. */
public record AbilityPersistenceError(String code, String path, String detail) {
    ...
    public static final String DUPLICATE_TAG = "DUPLICATE_TAG";
    ...
    public AbilityPersistenceError {
