...
/** Stable, bounded error information returned by the Mob persistence boundary. */
public record MobPersistenceError(String code, String path, String detail) {
